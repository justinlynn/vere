...
cc_library(
    ...
    deps = select({
        ...
        "@//bazel/toolchain/platforms/cpu:powerpc64le": [":softfloat_powerpc64le"],
        "//conditions:default": [],
    }),
)

cc_library(
    name = "softfloat_powerpc64le",
    srcs = [
        ...
        # `softfloat` repo.
        "source/POWERPC64LE/softfloat_raiseFlags.c",
        "source/POWERPC64LE/s_f16UIToCommonNaN.c",
        "source/POWERPC64LE/s_commonNaNToF16UI.c",
        "source/POWERPC64LE/s_propagateNaNF16UI.c",
        "source/POWERPC64LE/s_f32UIToCommonNaN.c",
        "source/POWERPC64LE/s_commonNaNToF32UI.c",
        "source/POWERPC64LE/s_propagateNaNF32UI.c",
        "source/POWERPC64LE/s_f64UIToCommonNaN.c",
        "source/POWERPC64LE/s_commonNaNToF64UI.c",
        "source/POWERPC64LE/s_propagateNaNF64UI.c",
        "source/POWERPC64LE/extF80M_isSignalingNaN.c",
        "source/POWERPC64LE/s_extF80UIToCommonNaN.c",
        "source/POWERPC64LE/s_commonNaNToExtF80UI.c",
        "source/POWERPC64LE/s_propagateNaNExtF80UI.c",
        "source/POWERPC64LE/f128M_isSignalingNaN.c",
        "source/POWERPC64LE/s_f128UIToCommonNaN.c",
        "source/POWERPC64LE/s_commonNaNToF128UI.c",
        "source/POWERPC64LE/s_propagateNaNF128UI.c",
        ...
        # `softfloat` repo.
        "build/Linux-powerpc64le-GCC/platform.h",
        ...
        "source/POWERPC64LE/specialize.h",
    ],
    hdrs = ["source/include/softfloat.h"],
    copts = [
        "-Iexternal/softfloat/build/Linux-powerpc64le-GCC",
        "-Iexternal/softfloat/source/POWERPC64LE",
        "-Werror-implicit-function-declaration",
        "-O2",
    ],
    includes = ["source/include","build/Linux-powerpc64le-GCC"],
    local_defines = [
